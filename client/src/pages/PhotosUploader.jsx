...
const PhotosUploader = ({addedPhotos, onChange}) => {
  ...
  const uploadPhoto = async (e) => {
    ...
    const { data: filenames } = await axios.post("/upload", photos, {
    ...
    <>
      <div className="flex gap-2">
        <input 
          ...
          type="text" 
          placeholder="Add using a link as jpg, png etc." 
        />
        <button 
      ...
      <div className="mt-2 gap-2 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
        ...
        <label 
          className="h-32 flex items-center justify-center gap-1 border bg-transparent rounded-2xl p-2 text-2xl text-gray-600 cursor-pointer"
        >
